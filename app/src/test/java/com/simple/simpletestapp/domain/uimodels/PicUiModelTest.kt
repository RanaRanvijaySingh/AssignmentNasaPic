package com.simple.simpletestapp.domain.uimodels
...
class PicUiModelTest : TestCase() {

    @Test
    fun `test model if data is populating`() {
        val actual = PicUiModel(
            "ESA/HubbleNASA",
            "2019-12-01",
        ...
        Assert.assertEquals(TestHelper.picUiModel, actual)
    }
}